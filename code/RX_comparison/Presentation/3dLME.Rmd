...
If you're running this script locally, don't execute the bash chunks for this bit or your computer will try to run the code. They're just here so that we can take a look at the code.
